...
with i2c.I2CMaster(i2c_bus) as bus:
	...
	while True:
		...
		bus.transaction(i2c.writing_bytes(expander_address1, 0x12, 0x81))
		ClearBus1()
		...
		bus.transaction(i2c.writing_bytes(expander_address1, 0x12, 0x3C))
		ClearBus1()
		
		bus.transaction(i2c.writing_bytes(expander_address1, 0x13, 0x04))
		bus.transaction(i2c.writing_bytes(expander_address1, 0x12, 0x42))
		ClearBus1()
		...
		bus.transaction(i2c.writing_bytes(expander_address1, 0x12, 0x90))
		ClearBus2()
		# third 8 columns
		...
		bus.transaction(i2c.writing_bytes(expander_address1, 0x12, 0x60))
		ClearBus3()
		
		bus.transaction(i2c.writing_bytes(expander_address2, 0x13, 0x04))
		bus.transaction(i2c.writing_bytes(expander_address1, 0x12, 0x2F))
		ClearBus3()